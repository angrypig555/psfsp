...
# disabled due to compiler errors
...
mv target/x86_64-pc-windows-gnu/release/client.exe target/x86_64-pc-windows-gnu/release/server.exe target/x86_64-pc-windows-gnu/win-x86_64
zip -r target/x86_64-pc-windows-gnu/win-x86_64.zip target/x86_64-pc-windows-gnu/win-x86_64
...
mv target/i686-pc-windows-gnu/release/client.exe target/i686-pc-windows-gnu/release/server.exe target/i686-pc-windows-gnu/win-i686
zip -r target/i686-pc-windows-gnu/win-i686.zip target/i686-pc-windows-gnu/win-i686
...
#mv target/aarch64-pc-windows-gnu/release/client.exe target/aarch64-pc-windows-gnu/release/server.exe target/aarch64-pc-windows-gnu/win-aarch64
...
mv target/x86_64-unknown-linux-musl/release/client target/x86_64-unknown-linux-musl/release/server target/x86_64-unknown-linux-musl/linux-x86_64
zip -r target/x86_64-unknown-linux-musl/linux-x86_64.zip target/x86_64-unknown-linux-musl/linux-x86_64
...
mv target/i686-unknown-linux-musl/release/client target/i686-unknown-linux-musl/release/server target/i686-unknown-linux-musl/linux-i686
zip -r target/i686-unknown-linux-musl/linux-i686.zip target/i686-unknown-linux-musl/linux-i686
...
mv target/aarch64-unknown-linux-musl/release/client target/aarch64-unknown-linux-musl/release/server target/aarch64-unknown-linux-musl/linux-aarch64
zip -r target/aarch64-unknown-linux-musl/linux-aarch64.zip target/aarch64-unknown-linux-musl/linux-aarch64
